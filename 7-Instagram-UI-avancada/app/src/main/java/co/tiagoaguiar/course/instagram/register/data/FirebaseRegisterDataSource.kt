  ...
  override fun create(email: String, callback: RegisterCallback) {
    FirebaseFirestore.getInstance()
      ...
      .addOnSuccessListener { documents ->
        // se minha busca/query ficou vazia nao tem user
  ...
  override fun updateUser(photoUri: Uri, callback: RegisterCallback) {
    ...
    imgRef.putFile(photoUri)
      .addOnSuccessListener { result ->
        ...
        // aqui a foto já foi para o Fire Storage e precisamos fazer o download da url da foto
        imgRef.downloadUrl
